package com.mutou.tqt.S2C {
	...
	public dynamic final class BanghuichatS2C extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const CHAT_INFO:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.mutou.tqt.S2C.BanghuichatS2C.chat_info", "chatInfo", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const MODIFY_TYPE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuichatS2C.modify_type", "modifyType", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const ID:FieldDescriptor$TYPE_FIXED64 = new FieldDescriptor$TYPE_FIXED64("com.mutou.tqt.S2C.BanghuichatS2C.id", "id", (3 << 3) | com.netease.protobuf.WireType.FIXED_64_BIT);
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (chat_info$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuichatS2C.chatInfo cannot be set twice.');
					}
					++chat_info$count;
				...
				case 2:
					if (modify_type$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuichatS2C.modifyType cannot be set twice.');
					}
					++modify_type$count;
				...
				case 3:
					if (id$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuichatS2C.id cannot be set twice.');
					}
					++id$count;
