package com.mutou.tqt.S2C {
	...
	public dynamic final class BanghuizhanjifenS2C extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuizhanjifenS2C.rank", "rank", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const JIFEN:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuizhanjifenS2C.jifen", "jifen", (2 << 3) | com.netease.protobuf.WireType.VARINT);

		private var jifen$field:int;
		 ...
		 *  @private
		 */
		public static const BID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuizhanjifenS2C.bid", "bid", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PERSON_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuizhanjifenS2C.person_num", "personNum", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BANGHUI_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.mutou.tqt.S2C.BanghuizhanjifenS2C.banghui_name", "banghuiName", (5 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const BANGHUI_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuizhanjifenS2C.banghui_level", "banghuiLevel", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BANGHUI_ICON:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuizhanjifenS2C.banghui_icon", "banghuiIcon", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const HUIZHANG_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.mutou.tqt.S2C.BanghuizhanjifenS2C.huizhang_name", "huizhangName", (8 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const HUIZHANG_UID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuizhanjifenS2C.huizhang_uid", "huizhangUid", (9 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function writeToBuffer(output:com.netease.protobuf.WritingBuffer):void {
			...
			if (hasJifen) {
				...
				com.netease.protobuf.WriteUtils.write$TYPE_INT32(output, jifen$field);
			}
			if (hasBid) {
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (rank$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuizhanjifenS2C.rank cannot be set twice.');
					}
					++rank$count;
				...
				case 2:
					if (jifen$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuizhanjifenS2C.jifen cannot be set twice.');
					}
					++jifen$count;
					this.jifen = com.netease.protobuf.ReadUtils.read$TYPE_INT32(input);
					break;
				case 3:
					if (bid$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuizhanjifenS2C.bid cannot be set twice.');
					}
					++bid$count;
				...
				case 4:
					if (person_num$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuizhanjifenS2C.personNum cannot be set twice.');
					}
					++person_num$count;
				...
				case 5:
					if (banghui_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuizhanjifenS2C.banghuiName cannot be set twice.');
					}
					++banghui_name$count;
				...
				case 6:
					if (banghui_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuizhanjifenS2C.banghuiLevel cannot be set twice.');
					}
					++banghui_level$count;
				...
				case 7:
					if (banghui_icon$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuizhanjifenS2C.banghuiIcon cannot be set twice.');
					}
					++banghui_icon$count;
				...
				case 8:
					if (huizhang_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuizhanjifenS2C.huizhangName cannot be set twice.');
					}
					++huizhang_name$count;
				...
				case 9:
					if (huizhang_uid$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuizhanjifenS2C.huizhangUid cannot be set twice.');
					}
					++huizhang_uid$count;
