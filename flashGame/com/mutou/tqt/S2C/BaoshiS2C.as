package com.mutou.tqt.S2C {
	...
	public dynamic final class BaoshiS2C extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const XID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BaoshiS2C.xid", "xid", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BaoshiS2C.num", "num", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (xid$count != 0) {
						throw new flash.errors.IOError('Bad data format: BaoshiS2C.xid cannot be set twice.');
					}
					++xid$count;
				...
				case 2:
					if (num$count != 0) {
						throw new flash.errors.IOError('Bad data format: BaoshiS2C.num cannot be set twice.');
					}
					++num$count;
