package com.mutou.tqt.S2C {
	...
	public dynamic final class BanghuixiangqingS2C extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const BID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuixiangqingS2C.bid", "bid", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const PERSON_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuixiangqingS2C.person_num", "personNum", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BANGHUI_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.mutou.tqt.S2C.BanghuixiangqingS2C.banghui_name", "banghuiName", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const BANGHUI_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuixiangqingS2C.banghui_level", "banghuiLevel", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const BANGHUI_ICON:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuixiangqingS2C.banghui_icon", "banghuiIcon", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const HUIZHANG_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.mutou.tqt.S2C.BanghuixiangqingS2C.huizhang_name", "huizhangName", (6 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const HUIZHANG_UID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BanghuixiangqingS2C.huizhang_uid", "huizhangUid", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CREATE_TIME:FieldDescriptor$TYPE_FIXED64 = new FieldDescriptor$TYPE_FIXED64("com.mutou.tqt.S2C.BanghuixiangqingS2C.create_time", "createTime", (8 << 3) | com.netease.protobuf.WireType.FIXED_64_BIT);
		 ...
		 *  @private
		 */
		public static const XUANYAN:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.mutou.tqt.S2C.BanghuixiangqingS2C.xuanyan", "xuanyan", (9 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (bid$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuixiangqingS2C.bid cannot be set twice.');
					}
					++bid$count;
				...
				case 2:
					if (person_num$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuixiangqingS2C.personNum cannot be set twice.');
					}
					++person_num$count;
				...
				case 3:
					if (banghui_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuixiangqingS2C.banghuiName cannot be set twice.');
					}
					++banghui_name$count;
				...
				case 4:
					if (banghui_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuixiangqingS2C.banghuiLevel cannot be set twice.');
					}
					++banghui_level$count;
				...
				case 5:
					if (banghui_icon$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuixiangqingS2C.banghuiIcon cannot be set twice.');
					}
					++banghui_icon$count;
				...
				case 6:
					if (huizhang_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuixiangqingS2C.huizhangName cannot be set twice.');
					}
					++huizhang_name$count;
				...
				case 7:
					if (huizhang_uid$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuixiangqingS2C.huizhangUid cannot be set twice.');
					}
					++huizhang_uid$count;
				...
				case 8:
					if (create_time$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuixiangqingS2C.createTime cannot be set twice.');
					}
					++create_time$count;
				...
				case 9:
					if (xuanyan$count != 0) {
						throw new flash.errors.IOError('Bad data format: BanghuixiangqingS2C.xuanyan cannot be set twice.');
					}
					++xuanyan$count;
