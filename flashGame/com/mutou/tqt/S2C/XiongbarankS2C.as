package com.mutou.tqt.S2C {
	...
	public dynamic final class XiongbarankS2C extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const UID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.XiongbarankS2C.uid", "uid", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const USER_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.mutou.tqt.S2C.XiongbarankS2C.user_name", "userName", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const USER_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.XiongbarankS2C.user_level", "userLevel", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.XiongbarankS2C.rank", "rank", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const CHONGBAI_COUNT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.XiongbarankS2C.chongbai_count", "chongbaiCount", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const LEITAI_RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.XiongbarankS2C.leitai_rank", "leitaiRank", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const USER_GUNID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.XiongbarankS2C.user_gunId", "userGunId", (7 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const USER_IMAGE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.XiongbarankS2C.user_image", "userImage", (8 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const USER_MOVIE_FRAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.mutou.tqt.S2C.XiongbarankS2C.user_movie_frame", "userMovieFrame", (9 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const USER_COLORS:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.mutou.tqt.S2C.XiongbarankS2C.user_colors", "userColors", (10 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (uid$count != 0) {
						throw new flash.errors.IOError('Bad data format: XiongbarankS2C.uid cannot be set twice.');
					}
					++uid$count;
				...
				case 2:
					if (user_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: XiongbarankS2C.userName cannot be set twice.');
					}
					++user_name$count;
				...
				case 3:
					if (user_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: XiongbarankS2C.userLevel cannot be set twice.');
					}
					++user_level$count;
				...
				case 4:
					if (rank$count != 0) {
						throw new flash.errors.IOError('Bad data format: XiongbarankS2C.rank cannot be set twice.');
					}
					++rank$count;
				...
				case 5:
					if (chongbai_count$count != 0) {
						throw new flash.errors.IOError('Bad data format: XiongbarankS2C.chongbaiCount cannot be set twice.');
					}
				...
				case 6:
					if (leitai_rank$count != 0) {
						throw new flash.errors.IOError('Bad data format: XiongbarankS2C.leitaiRank cannot be set twice.');
					}
					++leitai_rank$count;
				...
				case 7:
					if (user_gunId$count != 0) {
						throw new flash.errors.IOError('Bad data format: XiongbarankS2C.userGunId cannot be set twice.');
					}
					++user_gunId$count;
				...
				case 8:
					if (user_image$count != 0) {
						throw new flash.errors.IOError('Bad data format: XiongbarankS2C.userImage cannot be set twice.');
					}
					++user_image$count;
				...
				case 9:
					if (user_movie_frame$count != 0) {
						throw new flash.errors.IOError('Bad data format: XiongbarankS2C.userMovieFrame cannot be set twice.');
					}
				...
				case 10:
					if (user_colors$count != 0) {
						throw new flash.errors.IOError('Bad data format: XiongbarankS2C.userColors cannot be set twice.');
					}
					++user_colors$count;
