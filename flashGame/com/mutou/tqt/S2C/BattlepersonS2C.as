package com.mutou.tqt.S2C {
	...
	public dynamic final class BattlepersonS2C extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const UID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BattlepersonS2C.uid", "uid", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const USER_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.mutou.tqt.S2C.BattlepersonS2C.user_name", "userName", (2 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const USER_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BattlepersonS2C.user_level", "userLevel", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const USER_RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BattlepersonS2C.user_rank", "userRank", (4 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const USER_GUNID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BattlepersonS2C.user_gunId", "userGunId", (5 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const USER_IMAGE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BattlepersonS2C.user_image", "userImage", (6 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const USER_MOVIE_FRAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.mutou.tqt.S2C.BattlepersonS2C.user_movie_frame", "userMovieFrame", (7 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const USER_COLORS:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.mutou.tqt.S2C.BattlepersonS2C.user_colors", "userColors", (8 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
		 ...
		 *  @private
		 */
		public static const FIGHTPOINT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.mutou.tqt.S2C.BattlepersonS2C.fightPoint", "fightPoint", (9 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (uid$count != 0) {
						throw new flash.errors.IOError('Bad data format: BattlepersonS2C.uid cannot be set twice.');
					}
					++uid$count;
				...
				case 2:
					if (user_name$count != 0) {
						throw new flash.errors.IOError('Bad data format: BattlepersonS2C.userName cannot be set twice.');
					}
					++user_name$count;
				...
				case 3:
					if (user_level$count != 0) {
						throw new flash.errors.IOError('Bad data format: BattlepersonS2C.userLevel cannot be set twice.');
					}
					++user_level$count;
				...
				case 4:
					if (user_rank$count != 0) {
						throw new flash.errors.IOError('Bad data format: BattlepersonS2C.userRank cannot be set twice.');
					}
					++user_rank$count;
				...
				case 5:
					if (user_gunId$count != 0) {
						throw new flash.errors.IOError('Bad data format: BattlepersonS2C.userGunId cannot be set twice.');
					}
					++user_gunId$count;
				...
				case 6:
					if (user_image$count != 0) {
						throw new flash.errors.IOError('Bad data format: BattlepersonS2C.userImage cannot be set twice.');
					}
					++user_image$count;
				...
				case 7:
					if (user_movie_frame$count != 0) {
						throw new flash.errors.IOError('Bad data format: BattlepersonS2C.userMovieFrame cannot be set twice.');
					}
				...
				case 8:
					if (user_colors$count != 0) {
						throw new flash.errors.IOError('Bad data format: BattlepersonS2C.userColors cannot be set twice.');
					}
					++user_colors$count;
				...
				case 9:
					if (fightPoint$count != 0) {
						throw new flash.errors.IOError('Bad data format: BattlepersonS2C.fightPoint cannot be set twice.');
					}
					++fightPoint$count;
