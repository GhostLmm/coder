package com.fish.modules.core.gameVO
{
	...
	/** 土豪排行榜数据
	**/
	public class TuhaorankVO extends BaseVo
	{
		...
		**/
		...
		{
			if(initFlag){
				if(_bishiCount!=value){
					var old:int=_bishiCount;
					_bishiCount=value;
					onChangeAttr("bishiCount",_bishiCount,old);
				}
			}else{
				_bishiCount=value;
			}
...
		public static const Attributes:Array=["uid","userName","userLevel","rank","chongbaiCount","bishiCount","vipLevel","userGunId","userImage","userMovieFrame","userColors"];
