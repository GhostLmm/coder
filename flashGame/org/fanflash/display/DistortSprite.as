package org.fanflash.display {
	...
	*/
	public class DistortSprite extends Sprite {
		...
		private var _twScale:Number;
		private var _bwScale:Number;
		private var _htScale:Number;
		
		public function DistortSprite(dt:BitmapData = null, isShowControlDot:Boolean = false,
									  hp:int = 14, vp:int = 14,
									  topWidthScale:Number=1,bottomWidthScale:Number=1,heightScale:Number=1
		) {
			_twScale=topWidthScale;
			_bwScale=bottomWidthScale;
			_htScale=heightScale;
			this.wPrecision = hp;
			this.hPrecision = vp;
			this.bitmapData = dt;
...
//			this.controlList[7] = new SPoint(0, hHalf);	
			...
			var twHalf:Number=this.bitmapData.width*_twScale/2;
			var bwHalf:Number=this.bitmapData.width*_bwScale/2;
			var htHalf:Number=this.bitmapData.height*_htScale/2;
//			
//			
			this.controlList[0] = new SPoint(wHalf-twHalf,hHalf-htHalf);
			this.controlList[1] = new SPoint(wHalf,hHalf-htHalf);
			this.controlList[2] = new SPoint(wHalf+twHalf,hHalf-htHalf);
			this.controlList[3] = new SPoint(wHalf+(twHalf+bwHalf)/2,hHalf);
			this.controlList[4] = new SPoint(wHalf+bwHalf,hHalf+htHalf);
			this.controlList[5] = new SPoint(wHalf,hHalf+htHalf);
			this.controlList[6] = new SPoint(wHalf-bwHalf,hHalf+htHalf);
			this.controlList[7] = new SPoint(wHalf-(twHalf+bwHalf)/2,hHalf);
