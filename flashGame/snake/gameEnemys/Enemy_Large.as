package snake.gameEnemys
{
	...
	public class Enemy_Large extends Enemy
	{
		public function Enemy_Large()
		{
			super();
		}
...
//				trace(enemy_anim+"/"+enemy_fr+"/"+enemy_frOld);
				switch(enemy_anim)
				{
					case 0:
					{
					...
					case 1:
					{
						...
						else if (player.character_x - enemy_x > enemy_engagementDistance * 2)
						{
							enemy_anim = 2;
							enemy_fr = 0;
							enemy_frOld = 0;
					...
					case 4:
					{
						...
						if (enemy_fr == 72)
						{
							...
							if (enemy_face == 0)
							{
								...
								Particle.addParticle(1, enemy_tempPos_x, enemy_tempPos_y, -Math.PI, 0,0, 0, Math.cos(-0.05) * -16, Math.sin(-0.05) * -16, 0, int(-0.05 / (Math.PI * 2) * 64), 0, 0, 1, 25);
							}
							else
							{
								enemy_tempPos_x = enemy_x - enemy_large_anims[enemy_anim].gun_x[int(enemy_fr)] + 22;
								...
								Particle.addParticle(1, enemy_tempPos_x, enemy_tempPos_y, 0, 0,0, 0, Math.cos(0.05 + Math.PI) * -16, Math.sin(0.05 + Math.PI) * -16, 0, int((0.05 + Math.PI) / (Math.PI * 2) * 64), 0, 0, 1, 25);
							}
						}
						break;
					}
					...
					case 7:
					{
						...
						else if (player.character_x < enemy_x)
						{
							enemy_lineOfSightTimer = enemy_lineOfSightTimer + Math.abs(enemy_velX);
							if (enemy_lineOfSightTimer > 500)
							{
