...
{
	public class SimpleParticle_bg_2 extends SimpleParticle_bg
	{
		public function SimpleParticle_bg_2()
		{
			super();
		}
		public override function excuteLogic():void{
			...
			/*if (int(simpleParticle_bg_p1) != 2)
			{
				...
				if (Math.abs(character_x - simpleParticle_bg_x) < 75)
				{
				...
				if (kD[5] == true)
				{
					...
					rect.width = 50;
					rect.height = 50;
					rect.x = 150 + 50 * int(simpleParticle_bg_p1);
					rect.y = 0;
