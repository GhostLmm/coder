package snake.gameParticle.simpleParticle_bgs
{
	...
	public class SimpleParticle_bg_1 extends SimpleParticle_bg
	{
		public function SimpleParticle_bg_1()
		{
			super();
		}
		public override function excuteLogic():void{
			...
			/*if (int(simpleParticle_bg_p1) != 2)
			{
				...
				if (Math.abs(player.character_x - simpleParticle_bg_x) < 75)
				{
					if (Math.abs(player.character_y - 50 - simpleParticle_bg_y) < 75)
					{
						if (character_keycards > 0)
						{
				...
				if (character_keycards > 0)
				{
					...
					rect.width = 50;
					rect.height = 50;
					rect.x = 50 * int(simpleParticle_bg_p1);
					rect.y = 0;
