package ui.gonghui
{
	...
	public class MDI_BanghuiXuanyan extends Mediator
	{
		[Inject]
		public var window:BanghuiXuanyanWindow;
		
		public function MDI_BanghuiXuanyan()
		{
			super();
		}
		...
		{
			if(_msgType==C2SEmitter.REQ_ChangeBanghuiXuanyanHandler)
			{
				if(_code==1)
				{
					Util.flow("帮会宣言修改成功");
		...
		private function onChongzhiClicked(evt:Event):void
		{
			...
			C2SEmitter.changeBanghuiXuanyan(gonghuiModel.myBanghuiData.bid,window._fnt_shuru_gonggao.text);
		}
