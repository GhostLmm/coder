package ui.paihangbang
{
	...
	public class Panel_Xiongba_RankingWindow extends Panel_Base
	{
		public function Panel_Xiongba_RankingWindow()
		{
			super();
		}
		...
		protected override function initModule():void
		{
			...
			_scrollController.initItemClass(Item_XiongbaPanel);
		}
		...
		{			
			C2SEmitter.sendLeitaiRank();
		}
		private function updateShow():void
		{
			_scrollController.setData(rankModel.xiongbaDataArray);
		}
