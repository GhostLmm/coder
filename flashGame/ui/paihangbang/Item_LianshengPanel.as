package ui.paihangbang
{
	...
	public class Item_LianshengPanel extends Base_Item implements IGridItem
	{
		public function Item_LianshengPanel()
		{
			super();
		}
		private var _btn_chongbai:Button;
		private var _fnt_liansheng:FontField;
		...
		protected override function initModule():void
		{
			...
			_fnt_liansheng = new FontField(itemMaterial.fnt_zhanli);
		...
		private function detoryMc():void
		{
			...
			if(_fnt_liansheng){_fnt_liansheng.destory();_fnt_liansheng=null};
		...
		private function onChongbaiClicked(evt:Event):void
		{
			...
			rankModel.chongbai(data.userId,RankModel.Label_Liansheng);
		}
		protected override function setShow():void
		{
			if(data.userId==int(GLBaseData.userId))
			{
				var heroModel:HeroModel=Context.getInjectInstance(HeroModel);
				_fnt_liansheng.text=heroModel.heroZhandouli.toString();
			}
			else
			{
				_fnt_liansheng.text = data.zhandouli.toString();
			}
		...
		{
			var rankModel:RankModel=Context.getInjectInstance(RankModel);
			if(rankModel.checkIfAreadyChongbai(data.userId,RankModel.Label_Liansheng))
			{
				return true;
			}
			return false;
		...
		private function get itemMaterial():ItemZhanliBang 
		{
			return m_mc as ItemZhanliBang; 
		}
		protected override function get itemClassName():Class
		{
			return ItemZhanliBang; 
		}
		public function get data():LianshengData
		{
			return m_data as LianshengData;
		}
	}
}
