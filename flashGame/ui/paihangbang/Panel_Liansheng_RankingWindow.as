package ui.paihangbang
{
	...
	public class Panel_Liansheng_RankingWindow extends Panel_Base
	{
		public function Panel_Liansheng_RankingWindow()
		{
			super();
		}
		...
		protected override function initModule():void
		{
			...
			_scrollController.initItemClass(Item_LianshengPanel);
		}
		...
		{			
			C2SEmitter.sendLianshengRank();
		}
		private function updateShow():void
		{
			_scrollController.setData(rankModel.lianshengDataArray);
		}
