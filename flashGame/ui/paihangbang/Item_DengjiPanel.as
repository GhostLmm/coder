package ui.paihangbang
{
	...
	public class Item_DengjiPanel extends Base_Item implements IGridItem
	{
		public function Item_DengjiPanel()
		{
			super();
		}
		...
		private function onChongbaiClicked(evt:Event):void
		{
			...
			rankModel.chongbai(data.userId,RankModel.Label_Level);
		}
		...
		{
			var rankModel:RankModel=Context.getInjectInstance(RankModel);
			if(rankModel.checkIfAreadyChongbai(data.userId,RankModel.Label_Level))
			{
				return true;
			}
			return false;
		...
		private function get itemMaterial():ItemDengjiBang 
		{
			return m_mc as ItemDengjiBang;		}
		protected override function get itemClassName():Class
		{
			return ItemDengjiBang;
		}
		private function get data():DengjiData
		{
			return m_data as DengjiData;
		}
	}
}
