package ui.liaotian
{
	...
	public class Item_Liaotian_Banghui extends Base_Item implements IGridItemMax
	{
		public static const HuizhangPos:int=1;
		...
		public function Item_Liaotian_Banghui()
		{
			super();
		}
		...
		protected override function setShow():void
		{
			...
			if(chatData.pos==HuizhangPos)
			{
				_fnt_zhiwei.visible=true;
			}
			else
			{
		...
		public function get chatData():BanghuiChatData
		{
			return m_data as BanghuiChatData;
		}
