package ui.widget
{
	...
	public class Button extends Sprite implements ButtonInterface, IComponent
	{
...
//		private static const TargetScale:Number=0.8;
		...
		private var isTabButton:Boolean;
		
//		private static const EaseFN:*=
		
//		private var tap:TapGesture;
		
		public function setTabButton():void{
			isTabButton=true;
		}
		
		public function Button(view:MovieClip, container:MovieClip=null)
		{
...
//				trace("按钮点击成功");
				if(_isEnabled) {
					if(isTabButton){
						Music.playFX(Music.FX_tabclick);
					}else{
						Music.playFX(Music.FX_btnclick);
					}
